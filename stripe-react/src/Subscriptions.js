...
function UserData(props) {
  ...
  console.log(data.activePlans, data.stripeCustomerId, data)
      ...
      <AuthCheck fallback={<SignIn />}>
        ...
        <div className="well">
          ...
          <button
            className={
              'btn ' +
              (plan === 'price_1KZXtFSC2MIwJhdme4qmoy5u'
                ? 'btn-primary'
                : 'btn-outline-primary')
            }
            onClick={() => setPlan('price_1KZXtFSC2MIwJhdme4qmoy5u')}>
            Choose Monthly ₹500/m
          </button>

          <button
            className={
              'btn ' +
              (plan === 'price_1KZXvuSC2MIwJhdmVIPDmjcl'
                ? 'btn-primary'
                : 'btn-outline-primary')
            }
            onClick={() => setPlan('price_1KZXvuSC2MIwJhdmVIPDmjcl')}>
            Choose Quarterly ₹1500/q
          </button>
